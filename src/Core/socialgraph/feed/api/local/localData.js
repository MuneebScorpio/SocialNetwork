...
const mockPostsData = [
  ...
  },
  {
    ...
    postMedia: [
      {
        mime: 'image/jpeg',
        url: 'https://www.arq.ro/html/media/photos/0/9/385/big/teren-fotbal.jpg',
      },
    ],
    postText: 'Ghh',
    reactions: {
  ...
  },
  {
    ...
    postMedia: [
      {
        mime: 'image/jpeg',
        url: 'https://www.hdwallpapers.in/download/justice_league_artwork_4k-wide.jpg',
      },
    ],
    postText: 'Ghh',
    reactions: {
  ...
  },
  {
    ...
    postMedia: [
      {
        mime: 'image/jpeg',
        url: 'https://www.homestratosphere.com/wp-content/uploads/2015/11/Kitchen-with-new-white-cabinets-hs-jun28.jpg',
      },
    ],
    postText: 'Ghh',
    reactions: {
  ...
  },
  {
    ...
    postMedia: [
      {
        mime: 'image/jpeg',
        url: 'http://travelbylesley.co.uk/wp-content/uploads/2019/04/bigstock-Beautiful-tropical-beach-with-68649619-Copy.jpg',
      },
    ],
    postText: 'Ghh',
    reactions: {
  ...
  },
  {
    ...
    postMedia: [
      {
        mime: 'image/jpeg',
        url: 'https://firebasestorage.googleapis.com/v0/b/wpgone.appspot.com/o/IMG_20200820_032131_0.jpg?alt=media&token=1f47629c-4680-4714-826c-3a6eb4dd6492',
      },
    ],
    postText: 'Ghh',
    reactions: {
  ...
  },
  {
    ...
    postMedia: [
      {
        mime: 'image/jpeg',
        url: 'https://s.aolcdn.com/os/ab/_cms/2020/02/20092753/Bugatti-Chiron-Sport-Edition-Noire-Sportive-2.jpg',
      },
    ],
    postText: 'Ghh',
    reactions: {
